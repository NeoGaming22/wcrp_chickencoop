...
Citizen.CreateThread(function()
    ...
    if (Vdist(coords.x, coords.y, coords.z, -1583.41, -1393.52, 82.02) < 2.0) then
        sleep = false
            DrawTxt("Press [~e~G~q~] to Start Gatherin Eggs.", 0.50, 0.85, 0.7, 0.7, true, 255, 255, 255, 255, true)
...
--            DrawTxt("Press [~e~G~q~] to Smelt.", 0.50, 0.85, 0.7, 0.7, true, 255, 255, 255, 255, true)
--            if IsControlJustReleased(0, 0x760A9C6F) then -- g
